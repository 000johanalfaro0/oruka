...
**Versión publicada: 0.1.13.** La app se actualiza sola desde la 0.1.2. Publicar es `npm run publicar -- <version>
...
**Resuelto el 2026-08-22:** `v0.1.13` es la release `Latest`, así que
